$(function () {
    ...
    function syncDrawingData(data) {
        ...
        if(data.textarea_color == 'red'){
            document.getElementById("text_area").style.background_Color = "red"
        }
        if(data.textarea_color == 'yellow'){
            document.getElementById("text_area").style.background_Color = "yellow"
        }
        if(data.textarea_color == 'green'){
            document.getElementById("text_area").style.background_Color = "green"
        }        
